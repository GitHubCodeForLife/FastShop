...
exports.index = async(req, res, next)=>{
    ...
    res.render('./promotion/promotions',{title: 'Promotion Page', promotions: promotions});
}
...
exports.detail = async(req, res, next)=>{
   ...
   // res.json(detailPromotioin);
    res.render('./promotion/detail',{title: 'Promotion Detial Page',promotion:  detailPromotion});
}